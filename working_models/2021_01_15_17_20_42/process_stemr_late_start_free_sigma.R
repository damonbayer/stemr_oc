...
multi_chain_stem_fit <- read_rds("working_models/2021_01_15_17_20_42/res_2021_01_15_17_20_42.rds")
...
pp_data2 <-
  ...
  filter(time != 0) %>%
  left_join(select(multi_chain_stem_fit$data, time, tests)) %>%
  mutate(tests = tests,
