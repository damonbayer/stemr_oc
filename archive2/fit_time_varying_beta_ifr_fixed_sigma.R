...
dput(priors$to_estimation_scale(parameters))

par_initializer = function() {
  priors$from_estimation_scale(c(R0_init_est = 0.693147180559945, dur_latent_est = 0, dur_early_est = 0,
                                 dur_progress_est = -0.0618754037180875, ifr_shift_est = 0.06,
                                 rho_death_est = 0.847297860387204, phi_death_est = -0.394228680182135,
                                 alpha0_est = 1.38629436111989, alpha1_est = 1.38629436111989,
                                 kappa_est = -0.394228680182135) +
