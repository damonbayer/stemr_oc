...
coerced_stem_fit <- coerce_stem_fit_list(stem_fit_list)
coerced_stem_fit$n_chains <- n_chains
coerced_stem_fit$n_iterations <- (iterations - mcmc_kern$parameter_blocks[[1]]$control$stop_adaptation) / thinning_interval
# CHECK THIS
coerced_stem_fit$thinning_interval <- thinning_interval
write_rds(coerced_stem_fit, "fixed_init_sim/coerced_stem_fit.rds")
