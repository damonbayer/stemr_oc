...
potential_args <- c("2020-09-13", "2020-10-11", "2020-11-08", "2020-12-06",
                    "2021-01-03", "2021-01-31", "2021-02-28", "lower_R0", "higher_ifr",
                    "lower_alpha", "longer_infectious_period", "double_initial_counts",
                    "irvine", "santa_ana", "huntington_beach")
...
popsize <- case_when(args[1] == "irvine" ~ 264975L,
                       args[1] == "santa_ana" ~ 198471L,
                       args[1] == "huntington_beach" ~ 358874L,
                       TRUE ~ 3175692L)
...
write_rds(multi_chain_stem_fit, paste0("res_fit_stemr_final_models_", args[1], "_", my_seed, "_", format(Sys.time(), "%Y_%m_%d_%H_%M_%S"), ".rds"))
