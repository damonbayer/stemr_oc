...
source(fs::path("~/Documents/uci_covid_modeling/code", model_name, "helper_functions.R"))
...
model_objects$popsize <- sum(init_states[1:4])
...
write_rds(oc_post, "~/Documents/stemr_oc/fixed_init_sim/oc_post_more_precise.rds")
# write_rds(oc_post, "~/Documents/stemr_oc/fixed_init_sim/oc_post.rds")
...
write_rds(oc_prior, "~/Documents/stemr_oc/fixed_init_sim/oc_prior.rds")
# write_rds(oc_prior, "~/Documents/stemr_oc/fixed_init_sim/oc_prior_more_precise.rds")
